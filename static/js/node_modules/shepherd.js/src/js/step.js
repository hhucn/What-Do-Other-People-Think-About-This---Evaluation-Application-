...
import { Evented } from 'shepherd.js/src/js/evented.js';
import autoBind from 'shepherd.js/src/js/utils/auto-bind.js';
import {
  isElement,
  isHTMLElement,
  isFunction,
  isUndefined
} from 'shepherd.js/src/js/utils/type-check.js';
import { bindAdvance } from 'shepherd.js/src/js/utils/bind.js';
import { parseAttachTo, normalizePrefix, uuid } from 'shepherd.js/src/js/utils/general.js';
import {
  setupTooltip,
  destroyTooltip,
  mergeTooltipConfig
} from 'shepherd.js/src/js/utils/floating-ui.js';
import ShepherdElement from 'shepherd.js/src/js/components/shepherd-element.svelte';
